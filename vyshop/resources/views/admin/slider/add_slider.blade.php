                ...
                <div class="position-center">
                    <form role="form" action="{{URL::to("/insert-slider")}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="slider_name" class="form-control" id="exampleInputEmail1" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none" rows="5" class="form-control" name="slider_desc"  required></textarea>
                        </div>
                        <div class="form-group">
